      ...
      >
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-1/3 md:w-1/2 bg-slate-800 rounded-xl  flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            <form onSubmit={handleRegister} className="shadow-xl pt-3">
              <h2 className="text-slate-500 text-xl mb-1 font-bold text-center">
                Create an account
              </h2>
              ...
              <div className="flex flex-col gap-4 p-4 md:p-8">
                ...
                <button className="btn btn-info w-full">Register Now</button>
              </div>
